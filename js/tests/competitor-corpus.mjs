...
export const competitors = [
  ...
  },
  {
    ...
    stars: 45743,
    sourceFiles: 23,
    registrationSites: 287,
    scope: ['test/**/*.test.{js,cjs,mjs,ts}'],
  },
  {
    id: 'shelljs',
    project: 'ShellJS',
    ...
    stars: 14396,
    sourceFiles: 40,
    registrationSites: 630,
    scope: ['test/**/*.js (excluding resources and helpers)'],
  },
  {
    id: 'cross-spawn',
    project: 'cross-spawn',
  ...
  },
  {
    ...
    stars: 6523,
    sourceFiles: 5,
    registrationSites: 63,
    scope: ['src/__tests__/*.test.ts'],
    note: 'The repository is archived, but its published command wrapper remains widely used.',
  },
  {
    id: 'dax',
    project: 'Dax',
  ...
  },
  {
    ...
    stars: 7,
    sourceFiles: 14,
    registrationSites: 387,
    scope: ['mod.test.ts', 'src/**/*.test.ts'],
    note: 'Dax delegates command execution to this separately versioned engine.',
  },
  {
    id: 'nano-spawn',
    project: 'nano-spawn',
...
export const portedCases = [
  ...
  },
  {
    ...
    competitors: ['bun-shell', 'zx', 'dax', 'david-shell'],
    upstream: [
      'test/js/bun/shell/shell-interpreter.test.ts',
      'src/core.test.ts',
      'mod.test.ts',
...
export const missingFeatures = [
  ...
  },
  {
    ...
    competitors: ['cross-env'],
  },
  {
    id: 'environment-clear-and-remove',
    competitors: ['deno-command'],
  },
  {
    id: 'process-credentials',
    competitors: ['node-child-process', 'deno-command'],
  },
  {
    id: 'windows-process-window-options',
    competitors: ['node-child-process', 'deno-command'],
  },
  {
    id: 'child-process-handle-lifecycle',
    competitors: ['node-child-process', 'deno-command'],
  },
  { id: 'url-executable', competitors: ['deno-command'] },
