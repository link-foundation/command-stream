...
/**
 * Format JavaScript GitHub release notes using the format-release-notes.mjs script
 * Usage: bun scripts/format-github-release.mjs --release-version <version> --repository <repository> --commit-sha <commit_sha> [--tag-prefix js-v]
