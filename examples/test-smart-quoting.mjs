...
async function testSmartQuoting() {
  ...
  console.log('Expected: Should preserve single quotes without double-escaping');
  ...
  console.log('Expected: Should preserve double quotes (wrapped in single quotes for shell)');
  ...
  const edgeCases = [
    { desc: 'Just single quote', input: "'", expected: 'Should escape properly' },
    { desc: 'Just double quote', input: '"', expected: 'Should escape properly' },
    { desc: 'Empty single quotes', input: "''", expected: 'Should preserve as-is' },
    { desc: 'Empty double quotes', input: '""', expected: 'Should wrap in single quotes' },
    { desc: 'Nested quotes', input: '"\'nested\'"', expected: 'Should handle nested quotes' },
    { desc: 'Triple quotes', input: "'''", expected: 'Should escape all quotes' }
  ];
