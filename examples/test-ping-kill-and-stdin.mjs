...
async function testPingKillAndStdin() {
  try {
    ...
    console.log('✓ First 100 chars:', JSON.stringify(result.stdout.slice(0, 100)));
    ...
    console.log('');
    console.log('TEST 3: Verify stdin is available but process not started initially');
    ...
    console.log('');
    console.log('✅ ALL TESTS PASSED - ping kill() and streams.stdin work correctly!');
