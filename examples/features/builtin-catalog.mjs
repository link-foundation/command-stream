...
import { $, listCommands, enableVirtualCommands, disableVirtualCommands } from '../../src/$.mjs';
import { example } from './_harness.mjs';

const $q = $({ mirror: false });

await example({ id: 'builtin-catalog', title: 'The built-in command catalog' }, async ({ record }) => {
